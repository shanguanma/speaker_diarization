...
from multi_layer_conv import FsmnFeedForward
...
class FsmnEncoder(nn.Module):
    ...
    def __init__(self,
                 ...
                 sample_rate=1,
                 out_units=2517, #PSE labels have 2,517 possible categories. in `Speaker Overlap-aware Neural Diarization for Multi-party Meeting Analysis`
