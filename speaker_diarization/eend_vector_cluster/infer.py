#!/usr/bin/env python3
# Modified by: Duo MA from https://github.com/nttcslab-sp/EEND-vector-clustering/blob/main/eend/bin/infer.py
# Email: maduo@cuhk.edu.cn

import yamlargparse
from speaker_diarization.eend_vector_cluster.infer_vector_cluster import infer
