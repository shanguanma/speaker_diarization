#!/usr/bin/env python3
# Modified by: Duo MA from https://github.com/nttcslab-sp/EEND-vector-clustering/blob/main/eend/pytorch_backend/infer.py
...
from eend.eend_vector_cluster.train_vector_cluster import collate_fn_ns
from eend.eend_vector_cluster.models_vector_cluster import fix_state_dict
from eend.eend_vector_cluster.models_vector_cluster import TransformerDiarization
from eend.eend_vector_cluster.diarization_dataset_vector_cluster import DiarizationDatasetFromWave
