...
from eend.utils import str2bool
from eend.eend_m2f.train_mask_model import train

def get_parser():
    parser = yamlargparse.ArgumentParser(description='EEND training')
    parser.add_argument('-c', '--config', help='config file path',
                        action=yamlargparse.ActionConfigFile)
    parser.add_argument("--verbose", "-V", default=2, type=int, help="Verbose option")
    ## training setting
    ...
    parser.add_argument('--input-transform', default='logmel23_espnet',
                        choices=['', 'log', 'logmel', 'logmel23', 'logmel23_mn',
                                 'logmel23_mvn', 'logmel23_swn','logmel23_espnet'],
