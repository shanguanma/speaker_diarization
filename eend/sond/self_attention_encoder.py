...
from chunk_utilis import overlap_chunk
from nets_utils import make_pad_mask

from attention import MultiHeadSelfAttention, MultiHeadedAttentionSANM
from embedding import SinusoidalPositionEncoder
...
from subsampling import TooShortUttError
from subsampling import check_short_utt
from ctc import CTC #(TODO)Duo ma remove it
...
class SelfAttentionEncoder(nn.Module):
    ...
    def __init__(
        ...
        tf2torch_tensor_name_prefix_torch: str = "cd_scorer",
        tf2torch_tensor_name_prefix_tf: str = "EAND/compute_distance_layer",
        out_units=1,
    ):
