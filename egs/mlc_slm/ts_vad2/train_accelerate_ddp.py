...
for example, using two gpus to train this model without grad clip norm and no freeze speech encoder
    ...
    exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad1/ts_vad2_two_gpus_unfreeze_with_musan
   CUDA_VISIABLE_DEVICES=0,1 accelerate launch --main_process_port 12673 ts_vad2/train_accelerate_ddp.py \
    ...
    exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad1/ts_vad2_two_gpus_unfreeze_with_musan_and_rirs
