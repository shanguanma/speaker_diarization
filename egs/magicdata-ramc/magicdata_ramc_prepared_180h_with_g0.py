...
import re
import sys
# it is from https://github.com/MagicHub-io/MagicData-RAMC/blob/main/sd/scripts/prepare_magicdata_180h.py
def main():
    source_data_dir=sys.argv[1] # i.e./data/maduo/datasets/MagicData-RAMC/
    txt_dir = f"{source_data_dir}/MDT2021S003/TXT"
    wav_dir = f"{source_data_dir}/MDT2021S003/WAV"
    output_dir=sys.argv[2]# i.e. "/data/maduo/datasets/MagicData-RAMC/maduo_processed/kaldi_format"
