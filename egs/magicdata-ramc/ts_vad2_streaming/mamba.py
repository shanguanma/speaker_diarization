...
if __name__ == "__main__":
    ...
    output = model(input)
    print(f"output shape: {output.shape}") # torch.Size([64, 200, 384])
    input2=torch.randn(64,200,256).to("cuda")
    output2 = model2(input2)
    print(f"output2 shape: {output2.shape}") # torch.Size([64, 200, 512])
    ...
    print(f"output3 shape: {output3.shape}") #  torch.Size([64, 200, 384]) 
