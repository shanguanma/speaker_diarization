...
#grep -r Avg logs/run_spectral_cluster_release_hltsz_4090_stage104-105.log
#Avg CDER : 0.196
#Avg CDER : 0.142
#Avg CDER : 0.126
#Avg CDER : 0.122
...
if [ ${stage} -le 106 ] && [ ${stop_stage} -ge 106 ];then
    ...
    step_size=3
    skip_chunk_size=0.93
    pretrain_speaker_model_ckpt=/share/101/home/maduo/model_hub/speaker_pretrain_model/zh_cn/modelscope/speech_eres2netv2w24s4ep4_sv_zh-cn_16k-common/pretrained_eres2netv2w24s4ep4.ckpt
    #for sub in dev test;do
    #testset="dev test"
    testset="cssd_testset"
    model_name="ERes2NetV2_w24s4ep4_COMMON"
    for sub in $testset;do
     test_set_dir="/share/101/home/maduo/datasets/MagicData-RAMC/maduo_processed/kaldi_format/$sub/"
     dest_dir=/share/101/home/maduo/exp/speaker_diarization/spectral_cluster_magicdata-ramc/$sub
     mkdir -p $dest_dir
     for name in $vad_threshold;do
      python spectral_cluster/020_spectral_cluster_common.py\
         --pretrain_speaker_model_ckpt $pretrain_speaker_model_ckpt \
...
if [ ${stage} -le 107 ] && [ ${stop_stage} -ge 107 ];then
   ...
   for sub in $testset;do
    dest_dir="/share/101/home/maduo/exp/speaker_diarization/spectral_cluster_magicdata-ramc/$sub"
    test_set_dir_groundtruth=/share/101/home/maduo/datasets/MagicData-RAMC/maduo_processed/kaldi_format/$sub/rttm_debug_nog0
     for name in $vad_threshold;do
       echo "vad_threshold: $name"
...
#grep -r Avg logs/run_spectral_cluster_release_hltsz_4090_stage106-107.log
#Avg CDER : 0.196
#Avg CDER : 0.142
#Avg CDER : 0.126
#Avg CDER : 0.122
...
#Avg CDER : 0.105
#Avg CDER : 0.104
#Avg CDER : 0.103 # best der in collar=0.25
#Avg CDER : 0.103
#Avg CDER : 0.104
#Avg CDER : 0.103
#Avg CDER : 0.100
#Avg CDER : 0.095
#Avg CDER : 0.089 as report
#Avg CDER : 0.101
#Avg CDER : 0.100
#
...
# compared stage106-107, stage110-stage111 will compute DER
# here _ERes2NetV2_COMMON_zh_200k should be generated by pretrained_eres2netv2w24s4ep4.ckpt not pretrained_eres2netv2.ckpt
# i will rerun them from stage106-110
...
#grep -r DER logs/run_spectral_cluster_release_hltsz_4090_stage110.log
#DER score
# collar=0.0
#DER=45.57, miss=3.77, falarm=28.11, confusion=13.69
#DER=38.02, miss=4.32, falarm=21.87, confusion=11.82
#DER=37.03, miss=4.42, falarm=21.15, confusion=11.46
#DER=36.68, miss=4.54, falarm=20.46, confusion=11.68
#DER=35.80, miss=4.61, falarm=20.05, confusion=11.14
#DER=34.75, miss=4.87, falarm=18.81, confusion=11.07
...
#DER=33.46, miss=5.28, falarm=17.08, confusion=11.11
#DER=32.81, miss=5.35, falarm=16.72, confusion=10.74
#DER=32.27, miss=5.54, falarm=16.06, confusion=10.67
#DER=31.65, miss=5.78, falarm=15.38, confusion=10.48
#DER=31.14, miss=5.98, falarm=14.77, confusion=10.39
#DER=30.71, miss=6.19, falarm=14.25, confusion=10.27
#DER=29.79, miss=6.79, falarm=13.09, confusion=9.91
#DER=29.61, miss=6.98, falarm=12.83, confusion=9.79
#DER=29.50, miss=7.12, falarm=12.62, confusion=9.75
#DER=29.07, miss=7.58, falarm=11.97, confusion=9.52
#DER=28.99, miss=7.76, falarm=11.76, confusion=9.47
#DER=28.94, miss=7.94, falarm=11.56, confusion=9.44 #
#DER=28.79, miss=8.11, falarm=11.35, confusion=9.33 #
#DER=27.71, miss=10.01, falarm=8.77, confusion=8.93
#DER=27.93, miss=13.86, falarm=5.80, confusion=8.27
#DER=31.92, miss=23.16, falarm=2.84, confusion=5.93 # vad=0.8
#DER=50.87, miss=48.12, falarm=0.74, confusion=2.01 # vad=0.9
#DER=53.81, miss=51.41, falarm=0.62, confusion=1.77 # vad=0.91

# collar=0.25
#DER=24.88, miss=1.20, falarm=15.25, confusion=8.43
#DER=15.51, miss=1.42, falarm=7.55, confusion=6.54
#DER=14.48, miss=1.46, falarm=6.83, confusion=6.19
#DER=14.16, miss=1.51, falarm=6.20, confusion=6.45
#DER=13.31, miss=1.54, falarm=5.88, confusion=5.89
...
#DER=12.20, miss=1.83, falarm=4.35, confusion=6.02
#DER=11.62, miss=1.85, falarm=4.15, confusion=5.62
#DER=11.38, miss=1.95, falarm=3.82, confusion=5.61
#DER=11.07, miss=2.07, falarm=3.54, confusion=5.46
#DER=10.87, miss=2.18, falarm=3.28, confusion=5.41
#DER=10.70, miss=2.30, falarm=3.08, confusion=5.33
#DER=10.38, miss=2.69, falarm=2.64, confusion=5.05
#DER=10.34, miss=2.82, falarm=2.56, confusion=4.97
...
#DER=10.40, miss=3.59, falarm=2.14, confusion=4.68  # vad=0.53
#DER=11.05, miss=4.86, falarm=1.71, confusion=4.49  # vad=0.6
