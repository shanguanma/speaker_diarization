...
# compared with stage140-141  of run_ts_vad2_hltsz.sh, stage150-151 will use singl-backend=mamba2 to replese transformer
if [ ${stage} -le 150 ] && [ ${stop_stage} -ge 150 ];then
    ...
    #exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_wav-bert2.0_epoch40_front_fix_seed
    exp_dir=/data/maduo/exp/speaker_diarization/alimeeting/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_cam++_zh_200k_epoch40_front_fix_seed_lr1e4_single_backend_mamba2_d_state256__multi_backend_transformer_rs_len4_shift2
    data_dir="/data/maduo/datasets/alimeeting" # oracle target audio , mix audio and labels path
    rs_len=4
    segment_shift=2
    single_backend_type="mamba2"
...
if [ ${stage} -le 151 ] && [ ${stop_stage} -ge 151 ];then
 #exp_dir=/data/maduo/exp/speaker_diarization/alimeeting/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_cam++_zh_200k_epoch40_front_fix_seed_lr1e4_single_backend_mamba2_d_state256_multi_backend_transformer_rs_len4_shift2
  exp_dir=/data/maduo/exp/speaker_diarization/alimeeting/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_cam++_zh_200k_epoch40_front_fix_seed_lr1e4_single_backend_mamba2_d_state256__multi_backend_transformer_rs_len4_shift2
 model_file=$exp_dir/best-valid-der.pt
 rs_len=4
 segment_shift=1
...
if [ ${stage} -le 152 ] && [ ${stop_stage} -ge 152 ];then
    ...
    #exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_wav-bert2.0_epoch40_front_fix_seed
    exp_dir=/data/maduo/exp/speaker_diarization/alimeeting/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_cam++_zh_200k_epoch40_front_fix_seed_lr1e4_single_backend_mamba2_d_state128__multi_backend_transformer_rs_len4_shift2/
    data_dir="/data/maduo/datasets/alimeeting" # oracle target audio , mix audio and labels path
    rs_len=4
    segment_shift=2
    single_backend_type="mamba2"
