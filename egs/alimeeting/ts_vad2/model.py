...
class TSVADModel(nn.Module):
    def __init__(
        ...
        assert self.label_rate==25, f"self.label_rate is {elf.label_rate} not support!"
        ...
        self.speech_encoder, self.speech_down_or_up,self.pretrain_speech_encoder_dim = self.create_speech_encoder(sample_times,cfg,device)
    ...
    def create_speech_encoder(self,sample_times,cfg, device):
        ...
        return  self.speech_encoder, self.speech_down_or_up, pretrain_speech_encoder_dim
    ...
    def forward_common(
        ...
        if self.speech_encoder_type=="WavLM":
            ...
            x = x.view(B, -1, self.pretrain_speech_encoder_dim)  # B, 50 * T, self.pretrain_speech_encoder_dim
            x = x.transpose(1, 2)
