...
#
#Eval for threshold 0.45: DER 4.62%, MS 2.38%, FA 1.90%, SC 0.34% as report
#
...
#
#Eval for threshold 0.45: DER 5.47%, MS 2.78%, FA 1.98%, SC 0.71% as report
#
...
# spyder -r overlap -c 0.25 /mntcephfs/lab_data/maduo/model_hub/ts_vad/alimeeting_eval.rttm /mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_unfreeze_with_musan/Eval/Eval/res_rttm_0.45
# ╒═════════════╤════════════════╤═════════╤════════════╤═════════╤════════╕
# │ Recording   │   Duration (s) │   Miss. │   F.Alarm. │   Conf. │    DER │
# ╞═════════════╪════════════════╪═════════╪════════════╪═════════╪════════╡
# │ Overall     │        2782.96 │   8.62% │      3.24% │   1.07% │ 12.94% │
# ╘═════════════╧════════════════╧═════════╧════════════╧═════════╧════════╛

# Test and collar=0.25
#  spyder -r overlap -c 0.25 /mntcephfs/lab_data/maduo/model_hub/ts_vad/alimeeting_test.rttm /mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_unfreeze_with_musan/Test/Test/res_rttm_0.45
# DER metrics:
#╒═════════════╤════════════════╤═════════╤════════════╤═════════╤════════╕
#│ Recording   │   Duration (s) │   Miss. │   F.Alarm. │   Conf. │    DER │
#╞═════════════╪════════════════╪═════════╪════════════╪═════════╪════════╡
#│ Overall     │        6848.25 │  10.24% │      4.10% │   1.79% │ 16.13% │
#╘═════════════╧════════════════╧═════════╧════════════╧═════════╧════════╛
fi
...
# collar=0.0
# Eval
# perl  SCTK-2.4.12/src/md-eval/md-eval.pl -c 0.0 -s /mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_w2v-bert2.0_first6layer_epoch40_front_fix_seed_lr1e4/Eval/res_rttm_0.5 -r /mntcephfs/lab_data/maduo/model_hub/ts_vad/alimeeting_eval.rttm
# 11.88/5.95/4.98/0.95

# Test
#  perl  SCTK-2.4.12/src/md-eval/md-eval.pl -c 0.0 -s /mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_w2v-bert2.0_first6layer_epoch40_front_fix_seed_lr1e4/Test/res_rttm_0.5 -r /mntcephfs/lab_data/maduo/model_hub/ts_vad/alimeeting_test.rttm
# 12.21/6.35/4.63/1.23

# only overlap der
# pip install git+https://github.com/desh2608/spyder.git@main
# collar=0.0
# Eval
# spyder -r overlap -c 0.0  /mntcephfs/lab_data/maduo/model_hub/ts_vad/alimeeting_eval.rttm  /mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_w2v-bert2.0_first6layer_epoch40_front_fix_seed_lr1e4/Eval/res_rttm_0.5
#  Recording   │   Duration (s) │   Miss. │   F.Alarm. │   Conf. │    DER │
#╞═════════════╪════════════════╪═════════╪════════════╪═════════╪════════╡
#│ Overall     │        6678.07 │  13.72% │      2.47% │   1.77% │ 17.96% │

# Test
# spyder -r overlap -c 0.0  /mntcephfs/lab_data/maduo/model_hub/ts_vad/alimeeting_test.rttm  /mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_w2v-bert2.0_first6layer_epoch40_front_fix_seed_lr1e4/Test/res_rttm_0.5
# ╒═════════════╤════════════════╤═════════╤════════════╤═════════╤════════╕
#│ Recording   │   Duration (s) │   Miss. │   F.Alarm. │   Conf. │    DER │
#╞═════════════╪════════════════╪═════════╪════════════╪═════════╪════════╡
#│ Overall     │       16427.39 │  14.05% │      3.63% │   2.10% │ 19.77% │


# collar=0.25
# Eval
#  spyder -r overlap -c 0.25  /mntcephfs/lab_data/maduo/model_hub/ts_vad/alimeeting_eval.rttm  /mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_w2v-bert2.0_first6layer_epoch40_front_fix_seed_lr1e4/Eval/res_rttm_0.5
# ╒═════════════╤════════════════╤═════════╤════════════╤═════════╤════════╕
# │ Recording   │   Duration (s) │   Miss. │   F.Alarm. │   Conf. │    DER │
# ╞═════════════╪════════════════╪═════════╪════════════╪═════════╪════════╡
# │ Overall     │        2782.96 │   7.65% │      2.06% │   0.78% │ 10.49% │
# ╘═════════════╧════════════════╧═════════╧════════════╧═════════╧════════╛

# Test
#  spyder -r overlap -c 0.25  /mntcephfs/lab_data/maduo/model_hub/ts_vad/alimeeting_test.rttm  /mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_w2v-bert2.0_first6layer_epoch40_front_fix_seed_lr1e4/Test/res_rttm_0.5
# ╒═════════════╤════════════════╤═════════╤════════════╤═════════╤════════╕
# │ Recording   │   Duration (s) │   Miss. │   F.Alarm. │   Conf. │    DER │
# ╞═════════════╪════════════════╪═════════╪════════════╪═════════╪════════╡
# │ Overall     │        6848.25 │   9.53% │      2.71% │   1.20% │ 13.44% │
# ╘═════════════╧════════════════╧═════════╧════════════╧═════════╧════════╛
...
#grep -r 'Eval' logs/run_ts_vad2_stage130-131_A100.log``
# collar=0.0
# Eval of alimeeting
#Eval for threshold 0.20: DER 21.03%, MS 2.18%, FA 17.81%, SC 1.05%
#Eval for threshold 0.30: DER 16.50%, MS 3.36%, FA 11.87%, SC 1.27%
#Eval for threshold 0.35: DER 15.20%, MS 4.01%, FA 9.87%, SC 1.32%
#Eval for threshold 0.40: DER 14.27%, MS 4.66%, FA 8.26%, SC 1.34%
#Eval for threshold 0.45: DER 13.67%, MS 5.41%, FA 6.93%, SC 1.33%
#Eval for threshold 0.50: DER 13.29%, MS 6.28%, FA 5.75%, SC 1.26%
#Eval for threshold 0.55: DER 13.18%, MS 7.22%, FA 4.78%, SC 1.19%
#Eval for threshold 0.60: DER 13.29%, MS 8.22%, FA 3.97%, SC 1.10%
#Eval for threshold 0.70: DER 14.22%, MS 10.71%, FA 2.64%, SC 0.88%
#Eval for threshold 0.80: DER 16.46%, MS 14.21%, FA 1.64%, SC 0.61%
# Test of alimeeting
#Eval for threshold 0.20: DER 20.33%, MS 2.14%, FA 17.16%, SC 1.04%
#Eval for threshold 0.30: DER 15.98%, MS 3.40%, FA 11.31%, SC 1.28%
#Eval for threshold 0.35: DER 14.82%, MS 4.11%, FA 9.35%, SC 1.36%
#Eval for threshold 0.40: DER 14.02%, MS 4.90%, FA 7.73%, SC 1.39%
#Eval for threshold 0.45: DER 13.59%, MS 5.77%, FA 6.40%, SC 1.41%
#Eval for threshold 0.50: DER 13.38%, MS 6.70%, FA 5.25%, SC 1.43%
#Eval for threshold 0.55: DER 13.43%, MS 7.75%, FA 4.30%, SC 1.38%
#Eval for threshold 0.60: DER 13.72%, MS 8.89%, FA 3.52%, SC 1.31%
#Eval for threshold 0.70: DER 15.06%, MS 11.73%, FA 2.24%, SC 1.08%
#Eval for threshold 0.80: DER 17.77%, MS 15.72%, FA 1.29%, SC 0.76%

# collar=0.25
# Eval of alimeeting
#Eval for threshold 0.20: DER 9.73%, MS 0.80%, FA 8.65%, SC 0.28%
#Eval for threshold 0.30: DER 6.85%, MS 1.29%, FA 5.18%, SC 0.39%
#Eval for threshold 0.35: DER 6.07%, MS 1.55%, FA 4.10%, SC 0.42%
#Eval for threshold 0.40: DER 5.56%, MS 1.82%, FA 3.31%, SC 0.43%
#Eval for threshold 0.45: DER 5.24%, MS 2.17%, FA 2.63%, SC 0.44%
#Eval for threshold 0.50: DER 5.05%, MS 2.58%, FA 2.05%, SC 0.42%
#Eval for threshold 0.55: DER 5.08%, MS 3.08%, FA 1.61%, SC 0.39%
#Eval for threshold 0.60: DER 5.23%, MS 3.60%, FA 1.28%, SC 0.35%
#Eval for threshold 0.70: DER 6.06%, MS 5.00%, FA 0.80%, SC 0.26%
#Eval for threshold 0.80: DER 7.69%, MS 7.04%, FA 0.48%, SC 0.17%

# Test of alimeeting
#Eval for threshold 0.20: DER 9.75%, MS 0.90%, FA 8.42%, SC 0.42%
#Eval for threshold 0.30: DER 6.84%, MS 1.53%, FA 4.79%, SC 0.52%
#Eval for threshold 0.35: DER 6.17%, MS 1.91%, FA 3.70%, SC 0.56%
#Eval for threshold 0.40: DER 5.71%, MS 2.30%, FA 2.83%, SC 0.58%
#Eval for threshold 0.45: DER 5.53%, MS 2.75%, FA 2.18%, SC 0.60%
#Eval for threshold 0.50: DER 5.51%, MS 3.25%, FA 1.65%, SC 0.60%
#Eval for threshold 0.55: DER 5.63%, MS 3.83%, FA 1.23%, SC 0.58%
#Eval for threshold 0.60: DER 5.92%, MS 4.47%, FA 0.89%, SC 0.56%
#Eval for threshold 0.70: DER 6.98%, MS 6.11%, FA 0.43%, SC 0.43%
#Eval for threshold 0.80: DER 8.97%, MS 8.51%, FA 0.19%, SC 0.27%
...
#grep -r Eval logs/run_ts_vad2_stage132-133_A100.log
# collar=0.0
# Eval of alimeeting
#Eval for threshold 0.20: DER 22.01%, MS 2.32%, FA 18.70%, SC 1.00%
#Eval for threshold 0.30: DER 16.73%, MS 3.68%, FA 11.81%, SC 1.24%
#Eval for threshold 0.35: DER 15.39%, MS 4.47%, FA 9.62%, SC 1.31%
#Eval for threshold 0.40: DER 14.51%, MS 5.35%, FA 7.81%, SC 1.35%
#Eval for threshold 0.45: DER 13.92%, MS 6.28%, FA 6.31%, SC 1.33%
#Eval for threshold 0.50: DER 13.74%, MS 7.25%, FA 5.21%, SC 1.29%
#Eval for threshold 0.55: DER 13.73%, MS 8.30%, FA 4.23%, SC 1.19%
#Eval for threshold 0.60: DER 14.00%, MS 9.46%, FA 3.45%, SC 1.08%
#Eval for threshold 0.70: DER 15.46%, MS 12.44%, FA 2.25%, SC 0.77%
#Eval for threshold 0.80: DER 18.29%, MS 16.40%, FA 1.41%, SC 0.49%

# Test of alimeeting
#Eval for threshold 0.20: DER 22.77%, MS 2.14%, FA 19.56%, SC 1.07%
#Eval for threshold 0.30: DER 17.48%, MS 3.59%, FA 12.57%, SC 1.32%
#Eval for threshold 0.35: DER 15.99%, MS 4.38%, FA 10.20%, SC 1.41%
#Eval for threshold 0.40: DER 14.97%, MS 5.25%, FA 8.27%, SC 1.45%
#Eval for threshold 0.45: DER 14.42%, MS 6.26%, FA 6.68%, SC 1.48%
#Eval for threshold 0.50: DER 14.15%, MS 7.28%, FA 5.38%, SC 1.50%
#Eval for threshold 0.55: DER 14.21%, MS 8.47%, FA 4.28%, SC 1.45%
#Eval for threshold 0.60: DER 14.64%, MS 9.88%, FA 3.40%, SC 1.36%
#Eval for threshold 0.70: DER 16.36%, MS 13.23%, FA 2.05%, SC 1.07%
#Eval for threshold 0.80: DER 19.80%, MS 17.92%, FA 1.11%, SC 0.77%
#collar=0.25
# Eval of alimeeting
#Eval for threshold 0.20: DER 10.50%, MS 0.85%, FA 9.34%, SC 0.30%
#Eval for threshold 0.30: DER 7.09%, MS 1.43%, FA 5.26%, SC 0.40%
#Eval for threshold 0.35: DER 6.25%, MS 1.83%, FA 4.01%, SC 0.41%
#Eval for threshold 0.40: DER 5.74%, MS 2.25%, FA 3.06%, SC 0.43%
#Eval for threshold 0.45: DER 5.46%, MS 2.74%, FA 2.30%, SC 0.42%
#Eval for threshold 0.50: DER 5.45%, MS 3.22%, FA 1.81%, SC 0.41%
#Eval for threshold 0.55: DER 5.54%, MS 3.77%, FA 1.39%, SC 0.38%
#Eval for threshold 0.60: DER 5.83%, MS 4.42%, FA 1.08%, SC 0.33%
#Eval for threshold 0.70: DER 6.96%, MS 6.13%, FA 0.62%, SC 0.21%
#Eval for threshold 0.80: DER 9.10%, MS 8.57%, FA 0.42%, SC 0.11%
# Test of alimeeting
#Eval for threshold 0.20: DER 12.28%, MS 0.96%, FA 10.86%, SC 0.46%
#Eval for threshold 0.30: DER 8.42%, MS 1.69%, FA 6.18%, SC 0.55%
#Eval for threshold 0.35: DER 7.43%, MS 2.09%, FA 4.75%, SC 0.59%
#Eval for threshold 0.40: DER 6.75%, MS 2.54%, FA 3.59%, SC 0.62%
#Eval for threshold 0.45: DER 6.43%, MS 3.11%, FA 2.67%, SC 0.65%
#Eval for threshold 0.50: DER 6.29%, MS 3.66%, FA 1.96%, SC 0.66%
#Eval for threshold 0.55: DER 6.39%, MS 4.34%, FA 1.39%, SC 0.66%
#Eval for threshold 0.60: DER 6.78%, MS 5.17%, FA 0.98%, SC 0.62%
#Eval for threshold 0.70: DER 8.19%, MS 7.28%, FA 0.45%, SC 0.46%
#Eval for threshold 0.80: DER 10.85%, MS 10.36%, FA 0.18%, SC 0.31%
...
#grep -r Eval logs/run_ts_vad2_stage134-135-d_state384-rs_len6_A100.log
# collar=0.0
# Eval of alimeeting
#Eval for threshold 0.20: DER 20.51%, MS 2.24%, FA 17.31%, SC 0.96%
#Eval for threshold 0.30: DER 16.04%, MS 3.42%, FA 11.44%, SC 1.17%
#Eval for threshold 0.35: DER 14.82%, MS 4.05%, FA 9.56%, SC 1.21%
#Eval for threshold 0.40: DER 13.95%, MS 4.73%, FA 7.98%, SC 1.23%
#Eval for threshold 0.45: DER 13.39%, MS 5.46%, FA 6.73%, SC 1.20%
#Eval for threshold 0.50: DER 13.08%, MS 6.27%, FA 5.67%, SC 1.14%
#Eval for threshold 0.55: DER 12.99%, MS 7.16%, FA 4.74%, SC 1.10%
#Eval for threshold 0.60: DER 13.21%, MS 8.22%, FA 3.97%, SC 1.01%
#Eval for threshold 0.70: DER 14.10%, MS 10.62%, FA 2.66%, SC 0.82%
#Eval for threshold 0.80: DER 16.22%, MS 14.02%, FA 1.64%, SC 0.56%
# Test of alimeeting
#Eval for threshold 0.20: DER 20.13%, MS 2.14%, FA 16.90%, SC 1.09%
#Eval for threshold 0.30: DER 15.91%, MS 3.45%, FA 11.13%, SC 1.33%
#Eval for threshold 0.35: DER 14.68%, MS 4.17%, FA 9.10%, SC 1.41%
#Eval for threshold 0.40: DER 13.98%, MS 4.96%, FA 7.55%, SC 1.47%
#Eval for threshold 0.45: DER 13.60%, MS 5.86%, FA 6.24%, SC 1.51%
#Eval for threshold 0.50: DER 13.46%, MS 6.81%, FA 5.14%, SC 1.51%
#Eval for threshold 0.55: DER 13.56%, MS 7.87%, FA 4.19%, SC 1.50%
#Eval for threshold 0.60: DER 13.88%, MS 9.06%, FA 3.40%, SC 1.42%
#Eval for threshold 0.70: DER 15.24%, MS 11.95%, FA 2.17%, SC 1.13%
#Eval for threshold 0.80: DER 17.91%, MS 15.87%, FA 1.27%, SC 0.77%
#
# collarr=0.25
# Eval of alimeeting
#Eval for threshold 0.20: DER 9.27%, MS 0.77%, FA 8.23%, SC 0.26%
#Eval for threshold 0.30: DER 6.45%, MS 1.28%, FA 4.81%, SC 0.36%
#Eval for threshold 0.35: DER 5.74%, MS 1.55%, FA 3.83%, SC 0.36%
#Eval for threshold 0.40: DER 5.29%, MS 1.83%, FA 3.08%, SC 0.38%
#Eval for threshold 0.45: DER 4.99%, MS 2.13%, FA 2.50%, SC 0.36%
#Eval for threshold 0.50: DER 4.85%, MS 2.50%, FA 2.00%, SC 0.35%
#Eval for threshold 0.55: DER 4.89%, MS 2.95%, FA 1.62%, SC 0.32%
#Eval for threshold 0.60: DER 5.11%, MS 3.51%, FA 1.31%, SC 0.29%
#Eval for threshold 0.70: DER 5.95%, MS 4.89%, FA 0.82%, SC 0.24%
#Eval for threshold 0.80: DER 7.49%, MS 6.82%, FA 0.51%, SC 0.16%

# Test of alimeeting
#Eval for threshold 0.20: DER 9.61%, MS 0.89%, FA 8.26%, SC 0.47%
#Eval for threshold 0.30: DER 6.87%, MS 1.55%, FA 4.74%, SC 0.58%
#Eval for threshold 0.35: DER 6.14%, MS 1.92%, FA 3.60%, SC 0.63%
#Eval for threshold 0.40: DER 5.78%, MS 2.33%, FA 2.77%, SC 0.68%
#Eval for threshold 0.45: DER 5.64%, MS 2.79%, FA 2.14%, SC 0.71%
#Eval for threshold 0.50: DER 5.66%, MS 3.30%, FA 1.62%, SC 0.75%
#Eval for threshold 0.55: DER 5.80%, MS 3.88%, FA 1.16%, SC 0.76%
#Eval for threshold 0.60: DER 6.14%, MS 4.58%, FA 0.86%, SC 0.71%
#Eval for threshold 0.70: DER 7.23%, MS 6.32%, FA 0.42%, SC 0.49%
#Eval for threshold 0.80: DER 9.22%, MS 8.75%, FA 0.18%, SC 0.29%


#compared with stage128-129,stage136-137 rs_len will increase from 6 to 8
if [ ${stage} -le 136 ] && [ ${stop_stage} -ge 136 ];then
    ...
    #exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_wav-bert2.0_epoch40_front_fix_seed
    exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_cam++_zh_200k_epoch20_front_fix_seed_lr1e4_single_backend_mamba2_multi_backend_transformer_ts_len8_d_state_256
    data_dir="/mntcephfs/lab_data/maduo/datasets/alimeeting" # oracle target audio , mix audio and labels path
    rs_len=8
    segment_shift=2
    single_backend_type="mamba2"
...
# grep -r Eval logs/run_ts_vad2_stage136-137-rs_len8_d_stat256_A100.log
# collar=0.0
# Eval of alimeeting
#Eval for threshold 0.20: DER 19.77%, MS 2.36%, FA 16.39%, SC 1.02%
#Eval for threshold 0.30: DER 15.79%, MS 3.57%, FA 10.97%, SC 1.25%
#Eval for threshold 0.35: DER 14.64%, MS 4.27%, FA 9.10%, SC 1.27%
#Eval for threshold 0.40: DER 13.98%, MS 5.02%, FA 7.68%, SC 1.27%
#Eval for threshold 0.45: DER 13.51%, MS 5.81%, FA 6.45%, SC 1.25%
#Eval for threshold 0.50: DER 13.27%, MS 6.64%, FA 5.41%, SC 1.21%
#Eval for threshold 0.55: DER 13.27%, MS 7.56%, FA 4.54%, SC 1.17%
#Eval for threshold 0.60: DER 13.49%, MS 8.60%, FA 3.82%, SC 1.07%
#Eval for threshold 0.70: DER 14.52%, MS 11.06%, FA 2.63%, SC 0.83%
#Eval for threshold 0.80: DER 16.64%, MS 14.41%, FA 1.64%, SC 0.60%

# Test of alimeetig
#Eval for threshold 0.20: DER 19.47%, MS 2.17%, FA 16.37%, SC 0.93%
#Eval for threshold 0.30: DER 15.62%, MS 3.44%, FA 11.05%, SC 1.13%
#Eval for threshold 0.35: DER 14.50%, MS 4.11%, FA 9.22%, SC 1.18%
#Eval for threshold 0.40: DER 13.80%, MS 4.84%, FA 7.74%, SC 1.23%
#Eval for threshold 0.45: DER 13.36%, MS 5.62%, FA 6.49%, SC 1.25%
#Eval for threshold 0.50: DER 13.13%, MS 6.49%, FA 5.39%, SC 1.25%
#Eval for threshold 0.55: DER 13.17%, MS 7.47%, FA 4.48%, SC 1.21%
#Eval for threshold 0.60: DER 13.40%, MS 8.57%, FA 3.68%, SC 1.16%
#Eval for threshold 0.70: DER 14.65%, MS 11.31%, FA 2.41%, SC 0.94%
#Eval for threshold 0.80: DER 17.21%, MS 15.12%, FA 1.40%, SC 0.68%
# collar=0.25
# Eval of alimeeting
#Eval for threshold 0.20: DER 8.82%, MS 0.84%, FA 7.67%, SC 0.31%
#Eval for threshold 0.30: DER 6.29%, MS 1.35%, FA 4.56%, SC 0.38%
#Eval for threshold 0.35: DER 5.65%, MS 1.65%, FA 3.64%, SC 0.37%
#Eval for threshold 0.40: DER 5.29%, MS 2.00%, FA 2.94%, SC 0.35%
#Eval for threshold 0.45: DER 5.03%, MS 2.36%, FA 2.33%, SC 0.34%
#Eval for threshold 0.50: DER 4.93%, MS 2.77%, FA 1.82%, SC 0.35%
#Eval for threshold 0.55: DER 5.04%, MS 3.23%, FA 1.46%, SC 0.34%
#Eval for threshold 0.60: DER 5.30%, MS 3.81%, FA 1.19%, SC 0.30%
#Eval for threshold 0.70: DER 6.17%, MS 5.19%, FA 0.78%, SC 0.20%
#Eval for threshold 0.80: DER 7.77%, MS 7.19%, FA 0.45%, SC 0.13%

# Test of alimeeting
#Eval for threshold 0.20: DER 9.06%, MS 0.92%, FA 7.83%, SC 0.31%
#Eval for threshold 0.30: DER 6.46%, MS 1.53%, FA 4.56%, SC 0.38%
#Eval for threshold 0.35: DER 5.74%, MS 1.84%, FA 3.52%, SC 0.39%
#Eval for threshold 0.40: DER 5.33%, MS 2.20%, FA 2.73%, SC 0.41%
#Eval for threshold 0.45: DER 5.12%, MS 2.58%, FA 2.12%, SC 0.42%
#Eval for threshold 0.50: DER 5.07%, MS 3.03%, FA 1.61%, SC 0.43%
#Eval for threshold 0.55: DER 5.19%, MS 3.56%, FA 1.21%, SC 0.42%
#Eval for threshold 0.60: DER 5.47%, MS 4.18%, FA 0.89%, SC 0.40%
#Eval for threshold 0.70: DER 6.52%, MS 5.76%, FA 0.47%, SC 0.29%
#Eval for threshold 0.80: DER 8.47%, MS 8.07%, FA 0.21%, SC 0.19%


#compared with stage128-129,stage138-139 rs_len will increase from 6 to 10
if [ ${stage} -le 138 ] && [ ${stop_stage} -ge 138 ];then
    ...
    #exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_wav-bert2.0_epoch40_front_fix_seed
    exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_cam++_zh_200k_epoch20_front_fix_seed_lr1e4_single_backend_mamba2_multi_backend_transformer_ts_len10_d_state_256
    data_dir="/mntcephfs/lab_data/maduo/datasets/alimeeting" # oracle target audio , mix audio and labels path
    rs_len=10
    segment_shift=2
    single_backend_type="mamba2"
...
# grep -r Eval logs/run_ts_vad2_stage138-139-rs_len10_d_stat256_A100.log
# collar=0.0
# Eval of alimeeting
#Eval for threshold 0.20: DER 18.90%, MS 2.31%, FA 15.50%, SC 1.09%
#Eval for threshold 0.30: DER 15.31%, MS 3.40%, FA 10.70%, SC 1.21%
#Eval for threshold 0.35: DER 14.39%, MS 4.02%, FA 9.11%, SC 1.26%
#Eval for threshold 0.40: DER 13.63%, MS 4.68%, FA 7.70%, SC 1.25%
#Eval for threshold 0.45: DER 13.15%, MS 5.36%, FA 6.55%, SC 1.24%
#Eval for threshold 0.50: DER 12.85%, MS 6.12%, FA 5.54%, SC 1.19%
#Eval for threshold 0.55: DER 12.78%, MS 6.95%, FA 4.68%, SC 1.15%
#Eval for threshold 0.60: DER 12.92%, MS 7.89%, FA 3.95%, SC 1.07%
#Eval for threshold 0.70: DER 13.69%, MS 10.11%, FA 2.70%, SC 0.88%
#Eval for threshold 0.80: DER 15.73%, MS 13.35%, FA 1.75%, SC 0.63%

# Test of alimeeting
#Eval for threshold 0.20: DER 18.80%, MS 2.34%, FA 15.39%, SC 1.06%
#Eval for threshold 0.30: DER 15.26%, MS 3.54%, FA 10.46%, SC 1.26%
#Eval for threshold 0.35: DER 14.21%, MS 4.20%, FA 8.70%, SC 1.31%
#Eval for threshold 0.40: DER 13.53%, MS 4.89%, FA 7.32%, SC 1.32%
#Eval for threshold 0.45: DER 13.16%, MS 5.67%, FA 6.19%, SC 1.31%
#Eval for threshold 0.50: DER 13.00%, MS 6.51%, FA 5.20%, SC 1.29%
#Eval for threshold 0.55: DER 13.02%, MS 7.42%, FA 4.35%, SC 1.25%
#Eval for threshold 0.60: DER 13.25%, MS 8.48%, FA 3.60%, SC 1.17%
#Eval for threshold 0.70: DER 14.35%, MS 10.97%, FA 2.38%, SC 1.01%
#Eval for threshold 0.80: DER 16.57%, MS 14.41%, FA 1.41%, SC 0.75%

# collarr=0.25
# Eval of alimeeting
#Eval for threshold 0.20: DER 8.10%, MS 0.80%, FA 6.96%, SC 0.33%
#Eval for threshold 0.30: DER 5.90%, MS 1.23%, FA 4.29%, SC 0.37%
#Eval for threshold 0.35: DER 5.40%, MS 1.50%, FA 3.52%, SC 0.38%
#Eval for threshold 0.40: DER 5.01%, MS 1.79%, FA 2.85%, SC 0.38%
#Eval for threshold 0.45: DER 4.79%, MS 2.08%, FA 2.34%, SC 0.37%
#Eval for threshold 0.50: DER 4.69%, MS 2.43%, FA 1.91%, SC 0.36%
#Eval for threshold 0.55: DER 4.73%, MS 2.84%, FA 1.54%, SC 0.35%
#Eval for threshold 0.60: DER 4.89%, MS 3.32%, FA 1.24%, SC 0.34%
#Eval for threshold 0.70: DER 5.50%, MS 4.49%, FA 0.77%, SC 0.25%
#Eval for threshold 0.80: DER 7.01%, MS 6.36%, FA 0.50%, SC 0.15%

# Test of alimeeting
#Eval for threshold 0.20: DER 8.58%, MS 1.00%, FA 7.21%, SC 0.37%
#Eval for threshold 0.30: DER 6.24%, MS 1.57%, FA 4.21%, SC 0.47%
#Eval for threshold 0.35: DER 5.62%, MS 1.89%, FA 3.23%, SC 0.50%
#Eval for threshold 0.40: DER 5.26%, MS 2.23%, FA 2.52%, SC 0.51%
#Eval for threshold 0.45: DER 5.09%, MS 2.61%, FA 1.98%, SC 0.50%
#Eval for threshold 0.50: DER 5.05%, MS 3.04%, FA 1.53%, SC 0.49%
#Eval for threshold 0.55: DER 5.17%, MS 3.53%, FA 1.17%, SC 0.46%
#Eval for threshold 0.60: DER 5.44%, MS 4.11%, FA 0.90%, SC 0.43%
#Eval for threshold 0.70: DER 6.29%, MS 5.47%, FA 0.47%, SC 0.34%
#Eval for threshold 0.80: DER 7.91%, MS 7.46%, FA 0.22%, SC 0.23%


#compared with stage128-129,stage140-141 rs_len will increase from 6 to 12
if [ ${stage} -le 140 ] && [ ${stop_stage} -ge 140 ];then
    ...
    #exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_wav-bert2.0_epoch40_front_fix_seed
    exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_cam++_zh_200k_epoch20_front_fix_seed_lr1e4_single_backend_mamba2_multi_backend_transformer_ts_len12_d_state_256
    data_dir="/mntcephfs/lab_data/maduo/datasets/alimeeting" # oracle target audio , mix audio and labels path
    rs_len=12
    segment_shift=2
    single_backend_type="mamba2"
...
#compared with stage128-129,stage142-143 rs_len will increase from 6 to 15
if [ ${stage} -le 142 ] && [ ${stop_stage} -ge 142 ];then
    ...
    #exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_wav-bert2.0_epoch40_front_fix_seed
    exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_cam++_zh_200k_epoch20_front_fix_seed_lr1e4_single_backend_mamba2_multi_backend_transformer_ts_len15_d_state_256
    data_dir="/mntcephfs/lab_data/maduo/datasets/alimeeting" # oracle target audio , mix audio and labels path
    rs_len=15
    segment_shift=2
    single_backend_type="mamba2"
...
#grep -r Eval logs/run_ts_vad2_stage142-143-rs_len15_d_stat256_A100.log
# collar=0.0
# Eval of alimeeting
#Eval for threshold 0.20: DER 18.37%, MS 2.51%, FA 14.67%, SC 1.19%
#Eval for threshold 0.30: DER 15.36%, MS 3.60%, FA 10.38%, SC 1.39%
#Eval for threshold 0.35: DER 14.47%, MS 4.20%, FA 8.84%, SC 1.42%
#Eval for threshold 0.40: DER 13.80%, MS 4.81%, FA 7.58%, SC 1.41%
#Eval for threshold 0.45: DER 13.44%, MS 5.50%, FA 6.53%, SC 1.41%
#Eval for threshold 0.50: DER 13.15%, MS 6.21%, FA 5.59%, SC 1.36%
#Eval for threshold 0.55: DER 13.08%, MS 7.04%, FA 4.73%, SC 1.31%
#Eval for threshold 0.60: DER 13.28%, MS 8.00%, FA 4.03%, SC 1.25%
#Eval for threshold 0.70: DER 14.06%, MS 10.24%, FA 2.80%, SC 1.02%
#Eval for threshold 0.80: DER 15.85%, MS 13.30%, FA 1.83%, SC 0.72%

# Test of alimeeting
#Eval for threshold 0.20: DER 17.33%, MS 2.53%, FA 13.77%, SC 1.03%
#Eval for threshold 0.30: DER 14.34%, MS 3.76%, FA 9.40%, SC 1.18%
#Eval for threshold 0.35: DER 13.60%, MS 4.47%, FA 7.94%, SC 1.19%
#Eval for threshold 0.40: DER 13.08%, MS 5.18%, FA 6.71%, SC 1.20%
#Eval for threshold 0.45: DER 12.84%, MS 5.94%, FA 5.70%, SC 1.20%
#Eval for threshold 0.50: DER 12.76%, MS 6.77%, FA 4.79%, SC 1.20%
#Eval for threshold 0.55: DER 12.83%, MS 7.63%, FA 4.03%, SC 1.16%
#Eval for threshold 0.60: DER 13.13%, MS 8.66%, FA 3.38%, SC 1.10%
#Eval for threshold 0.70: DER 14.27%, MS 11.05%, FA 2.29%, SC 0.93%
#Eval for threshold 0.80: DER 16.35%, MS 14.26%, FA 1.42%, SC 0.67%

# collar=0.25
# Eval of alimeeting
#Eval for threshold 0.20: DER 8.01%, MS 0.90%, FA 6.71%, SC 0.40%
#Eval for threshold 0.30: DER 6.22%, MS 1.35%, FA 4.37%, SC 0.49%
#Eval for threshold 0.35: DER 5.70%, MS 1.63%, FA 3.56%, SC 0.51%
#Eval for threshold 0.40: DER 5.36%, MS 1.89%, FA 2.95%, SC 0.52%
#Eval for threshold 0.45: DER 5.18%, MS 2.21%, FA 2.46%, SC 0.51%
#Eval for threshold 0.50: DER 5.05%, MS 2.53%, FA 2.03%, SC 0.50%
#Eval for threshold 0.55: DER 5.08%, MS 2.96%, FA 1.66%, SC 0.47%
#Eval for threshold 0.60: DER 5.25%, MS 3.44%, FA 1.37%, SC 0.44%
#Eval for threshold 0.70: DER 5.84%, MS 4.65%, FA 0.85%, SC 0.34%
#Eval for threshold 0.80: DER 7.20%, MS 6.43%, FA 0.55%, SC 0.22%

# Test of alimeeting
#Eval for threshold 0.20: DER 7.45%, MS 1.10%, FA 6.01%, SC 0.34%
#Eval for threshold 0.30: DER 5.56%, MS 1.68%, FA 3.49%, SC 0.39%
#Eval for threshold 0.35: DER 5.20%, MS 2.05%, FA 2.76%, SC 0.39%
#Eval for threshold 0.40: DER 4.93%, MS 2.40%, FA 2.14%, SC 0.40%
#Eval for threshold 0.45: DER 4.88%, MS 2.80%, FA 1.68%, SC 0.40%
#Eval for threshold 0.50: DER 4.92%, MS 3.22%, FA 1.30%, SC 0.40%
#Eval for threshold 0.55: DER 5.09%, MS 3.69%, FA 1.02%, SC 0.38%
#Eval for threshold 0.60: DER 5.35%, MS 4.23%, FA 0.77%, SC 0.35%
#Eval for threshold 0.70: DER 6.23%, MS 5.50%, FA 0.44%, SC 0.29%
#Eval for threshold 0.80: DER 7.77%, MS 7.37%, FA 0.22%, SC 0.18%


#compared with stage142-143,stage144-145 cam++ embedding is changed from  cam++_zh-cn_200k_feature_dir to cam++_en_zh_advanced_feature_dir
if [ ${stage} -le 144 ] && [ ${stop_stage} -ge 144 ];then
    ...
    # for loading pretrain model weigt
    speech_encoder_type="CAM++"
    speech_encoder_path="/mntcephfs/lab_data/maduo/model_hub/speaker_pretrain_model/zh/modelscope/speech_campplus_sv_zh_en_16k-common_advanced/campplus_cn_en_common.pt"
    #speech_encoder_config="/mntcephfs/lab_data/maduo/model_hub/speaker_pretrain_model/w2v-bert2.0/config.json"
    dataset_name="alimeeting" # dataset name
    ...
    #exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_wav-bert2.0_epoch40_front_fix_seed
    exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_cam++_en_zh_advanced_feature_dir_epoch20_front_fix_seed_lr1e4_single_backend_mamba2_multi_backend_transformer_ts_len15_d_state_256
    data_dir="/mntcephfs/lab_data/maduo/datasets/alimeeting" # oracle target audio , mix audio and labels path
    rs_len=15
    segment_shift=2
    single_backend_type="mamba2"
...
if [ ${stage} -le 146 ] && [ ${stop_stage} -ge 146 ];then
    ...
    #exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_wav-bert2.0_epoch40_front_fix_seed
    exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_cam++_en_zh_advanced_feature_dir_epoch20_front_fix_seed_lr1e4_single_backend_mamba2_multi_backend_transformer_ts_len10_d_state_256
    data_dir="/mntcephfs/lab_data/maduo/datasets/alimeeting" # oracle target audio , mix audio and labels path
    rs_len=10
    segment_shift=2
    single_backend_type="mamba2"
...
if [ ${stage} -le 148 ] && [ ${stop_stage} -ge 148 ];then
    ...
    #exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_wav-bert2.0_epoch40_front_fix_seed
    exp_dir=/mntcephfs/lab_data/maduo/exp/speaker_diarization/ts_vad2/ts_vad2_two_gpus_freeze_with_musan_rirs_cam++_en_zh_advanced_feature_dir_epoch20_front_fix_seed_lr2e4_single_backend_conformer_6layer__multi_backend_lstm_ts_len6_ots_vad_style_v1
    data_dir="/mntcephfs/lab_data/maduo/datasets/alimeeting" # oracle target audio , mix audio and labels path
    rs_len=6
    segment_shift=2
