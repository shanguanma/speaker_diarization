...
def train_one_epoch(
    ...
    rank: int = 0,
    model_avg: Optional[nn.Module] = None,
    freeze_param: Optional[List] = None,
    update_param: Optional[List] = None,
...
#        optimizer.zero_grad(set_to_none=True)
    ...
    #dist.all_reduce(ddp_loss, op=dist.ReduceOp.SUM)
        ...
        if params.batch_idx_train < params.freeze_updates:
            ...
            #optimizer = AdamW([{'params': freeze_params, 'lr': 0.0},],lr=2e-4,betas=(0.9, 0.98),eps=1e-08, weight_decay=0.01)
...
def run(rank, world_size, args):
    ...
    freeze_param = list(model.module.speech_encoder.parameters())
    #update_param = [list(model.module.speech_down.parameters(),list(model.module.single_backend.parameters()),list(model.module.pos_encoder.parameters()),list(model.module.backend_down.parameters(),list(model.module.multi_backend.parameters()),list(model.module.fc.parameters())]
    update_param = list(model.module.speech_down.parameters())
    update_param +=list(model.module.single_backend.parameters())
    update_param +=list(model.module.pos_encoder.parameters())
    update_param +=list(model.module.backend_down.parameters())
    update_param +=list(model.module.multi_backend.parameters())
    update_param +=list(model.module.fc.parameters())
