...
from model5 import TSVADModel
from model5 import TSVADConfig
...
def compute_loss(
    ...
    with torch.set_grad_enabled(is_training):
        ...
        outs = model(ref_speech=ref_speech,target_speech=target_speech,labels=labels,labels_len=labels_len,num_updates=batch_idx_train)
...
def train_one_epoch(
    ...
    for batch_idx, batch in enumerate(train_dl):
        ...
        #    accelerator.clip_grad_norm_(model.parameters(), max_norm=None)
...
def main(args):
    ...
    world_size=2
    #logger.info(f"{args.exp_dir}/train_log.txt", main_process_only=False)
    # data part
