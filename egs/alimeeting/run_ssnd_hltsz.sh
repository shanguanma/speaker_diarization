...
if [ ${stage} -le 0 ] && [ ${stop_stage} -ge 0 ];then
   ...
   train_wav_dir=/data/maduo/datasets/alimeeting/Train_Ali_far/audio_dir
   train_textgrid_dir=/data/maduo/datasets/alimeeting/Train_Ali_far/textgrid_dir
   valid_wav_dir=/data/maduo/datasets/alimeeting/Eval_Ali/Eval_Ali_far/audio_dir
   valid_textgrid_dir=/data/maduo/datasets/alimeeting/Eval_Ali/Eval_Ali_far/textgrid_dir
