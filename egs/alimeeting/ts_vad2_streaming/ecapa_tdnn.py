...
'''
## it is from https://github.com/TaoRuijie/ECAPA-TDNN/blob/main/model.py
# compared with ecapa_tdnn_wespeaker.py, its model support specaug and fbank feature is mean normalized by default.
...
class ECAPA_TDNN(nn.Module):
    ...
    def __init__(self, C,speech_encoder=False):
    ...
    def forward(self, x, aug=False,get_time_out=False):
        with torch.no_grad():
