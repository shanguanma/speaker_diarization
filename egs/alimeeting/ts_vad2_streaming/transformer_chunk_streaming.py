...
LAYER_NORM_TYPE={"layer_norm": LayerNorm}
...
class TransformerEncoder(torch.nn.Module):
    ...
    def __init__(
        ...
        normalize_before: bool = True,#(TODO) offline it is false , todo check
        ...
        pos_enc_class = POS_ENC_LAYER_TYPE[pos_enc_layer_type] 
        # instant position class
        self.pos_enc = pos_enc_class(output_size,positional_dropout_rate)
        assert layer_norm_type in ['layer_norm']
        self.normalize_before = normalize_before
        self.after_norm = LAYER_NORM_TYPE[layer_norm_type](output_size,
                                                              eps=norm_eps)
