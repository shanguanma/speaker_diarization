...
from datasets_simu import load_dataset_simu
from datasets_simu import TSVADDataConfigSimu
...
def add_data_arguments(parser: argparse.ArgumentParser):
    ...
    parser.add_argument(
        "--data-dir",
        type=str,
        default="/mntcephfs/lab_data/maduo/datasets/alimeeting",  # oracle or system target audio and labels path
...
def add_data_model_common_arguments(parser: argparse.ArgumentParser):
    ...
    #parser.add_argument("--rs-len",type=int, default=4, help="mix audio length in ts_vad model")
...
def main(args):
    ...
    data_cfg.eval_test_spk_path = params.eval_test_spk_path
    data_cfg.speaker_embedding_name_dir = params.speaker_embedding_name_dir
    data_cfg.data_dir = params.data_dir
    data_cfg.eval_test_data_dir = params.eval_test_data_dir
    ...
    valid_dataset = load_dataset_simu(data_cfg, "Eval")
    train_dataset = load_dataset_simu(data_cfg, "Train")
