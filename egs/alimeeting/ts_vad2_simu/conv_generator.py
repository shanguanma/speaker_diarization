#!/usr/bin/env python3
# copy and modified from https://github.com/BUTSpeechFIT/EEND_dataprep/blob/main/v1/conv_generator.py
...
if __name__ == '__main__':
    ...
    print(f"seg_list: {seg_list}, seg_list[:, 2:]: {seg_list[:, 2:]}")
    seg_list[:, 2:] = (
    ...
    #print(f"session_split: {session_split}, seg_list[:-1, 1]: {seg_list[:-1, 1]},")
    groupbyspeaker = groupby(session_split, lambda e: e[0][0])
    #print(f"groupbyspeaker: {groupbyspeaker}")
